...
urlpatterns = patterns('',
    ...
    url('^_update_daily_average_for_author/$', tasks.update_daily_average_for_author),
    url('^_update_daily_average_for_all_authors/$', 
        tasks.update_daily_average_for_all_authors),
